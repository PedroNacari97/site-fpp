...
class EmissaoPassagem(models.Model):
    ...
    duracao_voo_ida_minutos = models.PositiveIntegerField(null=True, blank=True)
    fuso_horario_ida = models.SmallIntegerField(null=True, blank=True)
    duracao_voo_volta_minutos = models.PositiveIntegerField(null=True, blank=True)
    fuso_horario_volta = models.SmallIntegerField(null=True, blank=True)
