...
class Empresa(models.Model):
    ...
    cnpj = models.CharField(max_length=18, blank=True, unique=True, null=True, db_index=True)
    ...
    documento_titular = models.CharField(max_length=20, blank=True, help_text="CPF para PF ou CNPJ para PJ")
    origem = models.CharField(max_length=20, choices=(("manual", "Cadastro manual"), ("onboarding", "Auto-cadastro")), default="manual")
